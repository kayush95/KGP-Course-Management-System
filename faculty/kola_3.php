...
<head>
   ...
   <script type="text/javascript">
        ...
        function handleChange() {
            ...
            var key = 'Choose Topic';
            var value = 'newtopic';
            var key1 = 'Choose Sub-Topic';
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="active-menu" href="kola_3.php"><i class="fa fa-envelope"></i> Create Quiz </a>
                    </li>
                                        ...
                                        <div class="form-group">
                                            ...
                                            style=" border-radius:4px;-webkit-box-shadow: 0 3px 0 #ccc, 0 -1px #fff inset;
                                               ...
                                               background: #f8f8f8;
                                                ...
                                                appearance:none;
                                                cursor:pointer;">
                                                <option value="newtopic">Choose Topic</option>
                                                <?php
                                            ...
                                            <select class="form-control" name="select_sub_topic" id="select_sub_topic" onchange="handleChangeSubTopic()"
                                             style=" border-radius:4px;-webkit-box-shadow: 0 3px 0 #ccc, 0 -1px #fff inset;
                                               ...
                                               background: #f8f8f8;
                                                ...
                                                appearance:none;
                                                cursor:pointer;">
                                                <option value="newsubtopic">Choose Sub-Topic</option>
                                                <?php                                                   
                                                  /*$connection = mysql_connect($dbhost, $dbuser, $dbpass); //The Blank string is the password
                                                  mysql_select_db('dbms');
                                                  $table=mysql_query('SELECT * FROM courset WHERE facID=1 ');
