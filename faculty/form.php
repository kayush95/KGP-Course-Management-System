    ...
    if(isset($_POST['submitb'])){
        ...
        if($c_id === "none")
            ...
            if($_POST['optionsRadios'] === "none"){
                ...
                $target_dir = $_SERVER['DOCUMENT_ROOT'] . "/CMS2/" . $_POST["optionsRadios"] ."/";
                $uploadOk = 1;
                $target_file = $target_dir . basename($_FILES["fileToUpload"]["name"]); 
               // echo "Taget File = ".$target_file."<br>";
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="post" enctype="multipart/form-data" >
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="area1" name="area1" placeholder="Topic" style=
                                            ...
                                            <input type="text" id="area2" name="area2" placeholder="Sub-Topic" style=
                                            "border: 1px solid #848484; 
                                            -webkit-border-radius: 30px; 
                                            -moz-border-radius: 30px; 
                                            border-radius: 30px; 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    ...
                                                    <br/>
                                                    <input type="text" id="area5" name="area5" placeholder="lecture name" style=
                                            "border: 1px solid #848484; 
                                            -webkit-border-radius: 30px; 
                                            -moz-border-radius: 30px; 
                                            border-radius: 30px; 
                                            ...
                                            padding-right:10px;" required> 
                                                    <br/>
                                                    <input type="url" id="area" name="area" placeholder="video lecture url" style=
                                            "border: 1px solid #848484; 
                                            -webkit-border-radius: 30px; 
                                            -moz-border-radius: 30px; 
                                            border-radius: 30px; 
