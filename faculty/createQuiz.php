...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active" href="kola_3.php"><i class="fa fa-dashboard"></i>Create Quiz</a>
                    </li>       
		...
		<div class="row">
			...
			<?php 
				if(isset($_POST['select_sub_topic']))
				{
					//echo $_POST['select_sub_topic'];
					$_SESSION['current_subtopic_id'] = $_POST['select_sub_topic'];
					$_SESSION['i'] = 0;	
				}
			?>
			
			<!-- <?php echo $_SESSION['current_subtopic_id']; ?> -->
                        <?php include('quiz/add_quiz.php'); ?>
			<?php include('quiz/process_quizAdd.php'); ?>
			<br>
